...
- Remove hardcoding of paths (e.g. to get a path to a file in the PDK, take in PDK root dir as argument to a function, and concat the path to the specific file)
- Test Genus checkpointing
- Test running in different work directories
- Check whether everything that is being used is either globally installed or generated by Rivet
- Add more parametrization and move stuff to genus plugin if appropriate
- Make Innovus plugin
- Fix all `cargo clippy` errors
