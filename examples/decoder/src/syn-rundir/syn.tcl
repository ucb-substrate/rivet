...
read_hdl -sv /scratch/cs199-cbc/rivet/examples/decoder/src/decoder.v


elaborate decoder
init_design -top decoder
write_db -to_file /scratch/cs199-cbc/rivet/examples/decoder/src/syn-rundir/checkpoints/power_intent.cpf

read_power_intent -cpf /scratch/cs199-cbc/rivet/examples/decoder/src/syn-rundir/power_spec.cpf
apply_power_intent -summary
commit_power_intent

write_db -to_file /scratch/cs199-cbc/rivet/examples/decoder/src/syn-rundir/checkpoints/syn_generic.cpf

syn_generic
write_db -to_file /scratch/cs199-cbc/rivet/examples/decoder/src/syn-rundir/checkpoints/syn_map.cpf

syn_map
write_db -to_file /scratch/cs199-cbc/rivet/examples/decoder/src/syn-rundir/checkpoints/add_tieoffs.cpf
...
write_db -to_file /scratch/cs199-cbc/rivet/examples/decoder/src/syn-rundir/checkpoints/write_design.cpf
